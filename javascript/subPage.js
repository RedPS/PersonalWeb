  ...
  class Details {
    constructor() {
      ...
      const detailsTmpl = `
			<div class="details__bg details__bg--down">
				<button class="details__close"><i class="fas fa-2x fa-times icon--cross fa-close"></i></button>
      ...
      document.getElementById("main-wrapper").appendChild(this.DOM.details);
      this.init();
    }
    init() {
    ...
    open(data) {
      ...
      this.DOM.bgDown.style.transform = `translateX(${rect.productBgRect.left -
        ...
        rect.detailsBgRect.width}) scaleY(${rect.productBgRect.height /
        rect.detailsBgRect.height})`;
